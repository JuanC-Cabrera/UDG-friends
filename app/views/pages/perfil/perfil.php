...
<div style=" width: 80%; margin:auto; margin-top:20px" class="row">
    <div class="col-4">
        ...
        <div style="justify-content: center" class="card">
            ...
            <div class="foto-perfil">
                ...
                <?php if($datos['perfil']->idperfil == $_SESSION['logueado']):?>
    ...
    <?php if($datos['perfil']->idperfil == $_SESSION['logueado']):?>
        ...
        <form action="<?php echo URL_PROJECT ?>/home/publicar/<?php echo  $_SESSION['logueado']?>" enctype="multipart/form-data" method="POST" class="">
                <input type="hidden" name="id_user" value="<?php echo $_SESSION['logueado'] ?>">
        ...
        <?php foreach ($datos['publicaciones'] as $datosPublicacion) : ?>
            <?php if($datosPublicacion->idUserPublico ==$datos['perfil']->idperfil) :?>
            <div style="margin-bottom:10px;" class="card">
                ...
                <div class="">
                    <div>
                        ...
                        <a style="text-decoration:none; color:#000" href="<?php echo URL_PROJECT ?>/<?php echo ucwords($datosPublicacion->idUserPublico); ?>/perfil/"><div style="margin-top:-65px; margin-left:80px; font-size:20px " class="mb-3"><?php echo ucwords($datosPublicacion->usuario) ?></a>
                    ...
                    <div class="">
                        ...
                        <a style="color:#000;text-decoration:none" href="<?php echo URL_PROJECT ?>/<?php echo ucwords($datosComentarios->idUser); ?>/perfil/"><div style="margin-top:-40px; margin-left:60px; font-size:13px " class="mb-3"><?php echo ucwords($datosComentarios->usuario) ?></a>
